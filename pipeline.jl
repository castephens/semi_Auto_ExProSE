...
function runanalysis(out_dir::AbstractString,
    ...
    pca = PCA(ensemble)
    println("PRINTING PCA OBJECT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!") #christina
    println("*****************************************************************************") #christina 
    println("*****************************************************************************") #christina
    print(pca) #christina
    ...
    writepcviews("$out_dir/pymol/view_pc_", pca, ensemble.atoms, length(pca.evals)) #christina 
...
function runanalysis(out_dir::AbstractString,
    ...
    # Write PyMol scripts to view PCs
    writepcviews("$out_dir/pymol/view_pc_", pca, ensemble_com.atoms, length(pca.evals)) #christina 
